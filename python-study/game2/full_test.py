...
class TestGameAndBrand(unittest.TestCase):
    ...
    def test_brand_delete_return_true_whe_has_no_game(self):
        Brand("Brand10").save()
    ...
    # def test_brand_games_returns_empty_list(self):
    #     Brand("game16-brand").save()
    #     brand = Brand.find_by("name", "game16-brand")

    #     self.assertTrue(brand.games() == [])

    # def test_brand_games_returns_its_games(self):
    #     Brand("game17-brand").save()
    #     brand = Brand.find_by("name", "game17-brand")
    #     Game("game17", brand, 10, "2015-01-01").save()

    #     self.assertFalse(brand.games() == [])
    #     self.assertIsNotNone(game.brand())
    #     self.assertEqual("game17", brand.games()[0].name)
